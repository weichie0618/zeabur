    ...
    <div className="space-y-6 p-6">
      <div className="flex justify-between items-center">
        ...
        <div className="flex space-x-3">
          ...
          <Link href="/sales/orders/new" className="bg-amber-600 text-white px-4 py-2 rounded-md hover:bg-amber-700 text-sm font-medium inline-flex items-center">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div className="bg-white p-4 rounded-lg shadow-sm border border-gray-200">
          <div className="flex items-center">
            ...
            <div>
              <p className="text-sm text-gray-500">待出貨訂單</p>
              <p className="text-xl font-bold">{statusCounts.shipping}</p>
            </div>
          </div>
        </div>
        <div className="bg-white p-4 rounded-lg shadow-sm border border-gray-200">
          <div className="flex items-center">
            ...
            <div>
              <p className="text-sm text-gray-500">已完成訂單</p>
        ...
        <div className="bg-white p-4 rounded-lg shadow-sm border border-gray-200">
          <div className="flex items-center">
            ...
            <div>
              <p className="text-sm text-gray-500">已取消訂單</p>
      ...
      <div className="bg-white p-4 rounded-lg shadow-sm border border-gray-200">
        <div className="flex flex-wrap gap-4">
          ...
          <button className="bg-amber-100 text-amber-800 px-4 py-1.5 rounded-md hover:bg-amber-200 text-sm font-medium">
            重置過濾器
          </button>
        </div>
      </div>
      ...
      <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-200">
        <h2 className="text-lg font-medium mb-6">最近訂單趨勢</h2>
        <div className="h-64 flex items-center justify-center">
          <div className="w-full flex items-end justify-between space-x-2 px-8">
            {recentOrderCounts.map((day, index) => (
              <div key={index} className="flex flex-col items-center">
                <div className="flex-1 w-12 bg-amber-500 rounded-t" style={{ height: `${day.orders * 40}px` }}></div>
